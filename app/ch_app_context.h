...
struct ch_app_t {
    ...
    int (*app_content_process)(ch_app_t *app,ch_shm_format_t *fmt,ch_shm_record_t *rcd);

    void (*app_content_flush)(ch_app_t *app, ch_shm_format_t *fmt,ch_shm_record_t *rcd);

    void (*app_content_close)(ch_app_t *app,ch_shm_format_t *fmt,ch_shm_record_t *rcd);

};

extern void ch_app_context_init(ch_app_context_t *app_context,ch_pool_t *mp);
...
extern int ch_app_context_content_process(ch_app_context_t *app_context,ch_app_t *app,ch_shm_format_t *fmt,ch_shm_record_t *rcd);

extern void ch_app_context_content_flush(ch_app_context_t *app_context,ch_app_t *app,ch_shm_format_t *fmt,ch_shm_record_t *rcd);

extern void ch_app_context_content_close(ch_app_context_t *app_context,ch_app_t *app,ch_shm_format_t *fmt,ch_shm_record_t *rcd);

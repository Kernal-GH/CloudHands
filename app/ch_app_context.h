...
extern ch_app_t * ch_app_context_find_by_common_port(ch_app_context_t *app_context,uint16_t src_port,uint16_t dst_port);
...
extern int ch_app_context_content_parse(ch_app_context_t *app_context,ch_app_t *app,ch_assemble_session_t *ass,void *data,size_t dlen);


extern void ch_app_context_content_flush(ch_app_context_t *app_context,ch_app_t *app,ch_assemble_session_t *ass);


extern void ch_app_context_content_close(ch_app_context_t *app_context,ch_app_t *app,ch_assemble_session_t *ass);

...
void ch_app_context_init(ch_app_context_t *app_context,ch_context_t *context){
...
int ch_app_context_content_process(ch_app_context_t *app_context,ch_app_t *app,void *data,size_t dlen,void *priv_data){
    ...
    return app->app_content_process(app,data,dlen,priv_data); 
}

void ch_app_context_content_flush(ch_app_context_t *app_context,ch_app_t *app,void *priv_data){

    app->app_content_flush(app,priv_data);
}


void ch_app_context_content_close(ch_app_context_t *app_context,ch_app_t *app,void *priv_data){

    app->app_content_close(app,priv_data);
}

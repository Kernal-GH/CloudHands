...
extern int mail_smtp_request_parse(ch_mail_session_entry_t *msentry, void *data,size_t  dlen);

extern int mail_smtp_response_parse(ch_mail_session_entry_t *msentry, void *data, size_t dlen);

...
extern int mail_pop3_request_parse(ch_mail_session_entry_t *msentry, void *data, size_t dlen);

extern int mail_pop3_response_parse(ch_mail_session_entry_t *msentry, void *data, size_t dlen);

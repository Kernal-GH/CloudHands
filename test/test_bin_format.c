...
static int test_bin_format(void){
    ...
    rc = ch_bf_short_write(bf_fmt,TV);
    tlen+=rc;
    ...
    rc = ch_bf_int16_write(bf_fmt,TV);
    tlen+=rc;
    ...
    rc = ch_bf_int32_write(bf_fmt,TV);
    tlen+=rc;
    ...
    rc = ch_bf_int64_write(bf_fmt,TV);
    tlen+=rc;
    ...
    CH_TEST_ASSERT_EQUAL(ch_bf_short_read(bf),TV,"Short Read error!");
    CH_TEST_ASSERT_EQUAL(ch_bf_short_read(bf),0,"Short Read error!");
    CH_TEST_ASSERT_EQUAL(ch_bf_short_read(bf),-TV,"Short Read error!");
    CH_TEST_ASSERT_EQUAL(ch_bf_int_read(bf),TV,"Int Read error!");
    CH_TEST_ASSERT_EQUAL(ch_bf_int_read(bf),0,"Int Read error!");
    CH_TEST_ASSERT_EQUAL(ch_bf_int_read(bf),-TV,"Int Read error!");
    CH_TEST_ASSERT_EQUAL(ch_bf_long_read(bf),TV,"Long Read error!");
    CH_TEST_ASSERT_EQUAL(ch_bf_long_read(bf),0,"Long Read error!");
    CH_TEST_ASSERT_EQUAL(ch_bf_long_read(bf),-TV,"Long Read error!");
    CH_TEST_ASSERT_EQUAL(ch_bf_ushort_read(bf),TV,"Ushort Read error!");
    CH_TEST_ASSERT_EQUAL(ch_bf_ushort_read(bf),0,"Ushort Read error!");
    CH_TEST_ASSERT_EQUAL(ch_bf_uint_read(bf),TV,"UInt Read error!");
    CH_TEST_ASSERT_EQUAL(ch_bf_uint_read(bf),0,"UInt Read error!");
    CH_TEST_ASSERT_EQUAL(ch_bf_ulong_read(bf),TV,"ULong Read error!");
    CH_TEST_ASSERT_EQUAL(ch_bf_ulong_read(bf),0,"ULong Read error!");
    CH_TEST_ASSERT_EQUAL(ch_bf_size_read(bf),TV,"Size Read error!");
    CH_TEST_ASSERT_EQUAL(ch_bf_size_read(bf),0,"Size Read error!");
    CH_TEST_ASSERT_EQUAL(ch_bf_off_read(bf),TV,"off Read error!");
    CH_TEST_ASSERT_EQUAL(ch_bf_off_read(bf),0,"off Read error!");
    CH_TEST_ASSERT_EQUAL(ch_bf_ssize_read(bf),TV,"SSize Read error!");
    CH_TEST_ASSERT_EQUAL(ch_bf_ssize_read(bf),0,"SSize Read error!");
    CH_TEST_ASSERT_EQUAL(ch_bf_ssize_read(bf),-TV,"SSize Read error!");

    CH_TEST_ASSERT_EQUAL(ch_bf_int8_read(bf),TV,"int8 Read error!");
    CH_TEST_ASSERT_EQUAL(ch_bf_int8_read(bf),0,"int8 Read error!");
    CH_TEST_ASSERT_EQUAL(ch_bf_int8_read(bf),-TV,"int8 Read error!");

    CH_TEST_ASSERT_EQUAL(ch_bf_int16_read(bf),TV,"int16 Read error!");
    CH_TEST_ASSERT_EQUAL(ch_bf_int16_read(bf),0,"int16 Read error!");
    CH_TEST_ASSERT_EQUAL(ch_bf_int16_read(bf),-TV,"int16 Read error!");

    CH_TEST_ASSERT_EQUAL(ch_bf_int32_read(bf),TV,"int32 Read error!");
    CH_TEST_ASSERT_EQUAL(ch_bf_int32_read(bf),0,"int32 Read error!");
    CH_TEST_ASSERT_EQUAL(ch_bf_int32_read(bf),-TV,"int32 Read error!");

    CH_TEST_ASSERT_EQUAL(ch_bf_int64_read(bf),TV,"int64 Read error!");
    CH_TEST_ASSERT_EQUAL(ch_bf_int64_read(bf),0,"int64 Read error!");
    CH_TEST_ASSERT_EQUAL(ch_bf_int64_read(bf),-TV,"int64 Read error!");

    CH_TEST_ASSERT_EQUAL(ch_bf_uint8_read(bf),TV,"uint8 read error!");
    CH_TEST_ASSERT_EQUAL(ch_bf_uint8_read(bf),0,"uint8 read error!");

    CH_TEST_ASSERT_EQUAL(ch_bf_uint16_read(bf),TV,"uint16 read error!");
    CH_TEST_ASSERT_EQUAL(ch_bf_uint16_read(bf),0,"uint16 read error!");

    CH_TEST_ASSERT_EQUAL(ch_bf_uint32_read(bf),TV,"uint32 read error!");
    CH_TEST_ASSERT_EQUAL(ch_bf_uint32_read(bf),0,"uint32 read error!");

    CH_TEST_ASSERT_EQUAL(ch_bf_uint64_read(bf),TV,"uint64 read error!");

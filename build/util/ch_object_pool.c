 ...
 * Last Modified: 2017-12-28 18:33:38
 */
...
ch_object_pool_t * ch_object_pool_create(apr_pool_t *mp,size_t object_limits,
	size_t object_size,
	void *priv_data,
	...
	ch_object_pool_t *objp = (ch_object_pool_t *) apr_palloc(mp,sizeof(*objp));
...
void ch_object_pool_dump(ch_object_pool_t *omp,FILE *fp){
	...
	fprintf(fp,"The object size:%lu",(unsigned long)(omp->object_size+sizeof(ch_object_item_t)));

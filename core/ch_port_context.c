 ...
 *   Description: ---
 *        Create: 2016-08-23 00:58:21
 * Last Modified: 2017-02-24 13:26:39
 */
...
static const char *cmd_rx_pthresh(cmd_parms *cmd, void *_dcfg, const char *p1){
...
static const char *cmd_rx_hthresh(cmd_parms *cmd, void *_dcfg, const char *p1){
...
static const char *cmd_rx_wthresh(cmd_parms *cmd, void *_dcfg, const char *p1){
...
static const char *cmd_rx_free_thresh(cmd_parms *cmd, void *_dcfg, const char *p1){
...
static const char *cmd_rx_drop_enable(cmd_parms *cmd, void *_dcfg, const char *p1){
...
static const char *cmd_rss_hf(cmd_parms *cmd, void *_dcfg, const char *p1){
...
static const char *cmd_rx_mbuf_size(cmd_parms *cmd, void *_dcfg, const char *p1){
...
static const char *cmd_n_rx_mbuf_cache_size(cmd_parms *cmd, void *_dcfg, const char *p1){
...
static const char *cmd_port_jumbo_frame(cmd_parms *cmd, void *_dcfg, const char *p1,const char *p2){
...
ch_port_context_t* ch_port_context_create(ch_context_t *context){

	const char *cfname = context->port_cfname;

	ch_port_context_t *pcontext = apr_pcalloc(context->mp,sizeof(ch_port_context_t));
    ...
    msg = ch_process_command_config(port_context_directives,(void*)pcontext,context->mp,context->mp,cfname);
